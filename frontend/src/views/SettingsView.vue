<template>
  <div class="px-6 py-8 max-w-3xl mx-auto">
    ...
    <div class="bg-white rounded-2xl border border-gray-200 p-6 mb-4">
      ...
      <div class="flex items-center gap-4">
        ...
        <div>
          ...
          <p class="text-xs text-gray-400 mt-1">Signed in with Google</p>
        </div>
      </div>
    </div>
    ...
    <div class="bg-white rounded-2xl border border-gray-200 p-6 mb-4">
      <h2 class="text-base font-semibold text-gray-900 mb-4">Preferences</h2>
    ...
    <div class="bg-white rounded-2xl border border-red-200 p-6">
      <h2 class="text-base font-semibold text-red-700 mb-4">Danger Zone</h2>
      <div class="flex items-center justify-between">
        <div>
          <p class="text-sm font-medium text-gray-900">Sign out</p>
          <p class="text-xs text-gray-500 mt-0.5">You'll need to sign in again to access your account.</p>
        </div>
        <button
