<template>
  <div class="flex flex-col h-full bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 w-64">
    <!-- Logo -->
    <div class="flex items-center gap-2.5 px-5 py-5 border-b border-gray-100 dark:border-gray-700">
      ...
      <span class="text-base font-bold text-gray-900 dark:text-white">KeyBudget</span>
    </div>
    ...
    <nav class="flex-1 px-3 py-4 space-y-0.5 overflow-y-auto">
      <RouterLink
        ...
        :class="[
          isActive(item.to)
            ? 'bg-primary-50 text-primary-700 dark:bg-primary-800/30 dark:text-primary-200'
    ...
    <div class="px-3 py-4 border-t border-gray-100 dark:border-gray-700">
      ...
      <button
        class="mt-1 flex items-center gap-3 w-full px-3 py-2 rounded-lg text-sm font-medium text-gray-600 hover:bg-gray-100 hover:text-gray-900 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white transition-colors"
        @click="handleLogout"
      >
        <svg
          class="w-5 h-5"
